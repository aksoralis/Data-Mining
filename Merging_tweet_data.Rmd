...
```{r}
file_paths1 <- fs::dir_ls("C:/Users/13204/Documents/Data Mining/Final_Project/DATA318 Final Project/MuskTweets17-19")
file_contents1 <- list()

file_paths2 <- fs::dir_ls("C:/Users/13204/Documents/Data Mining/Final_Project/DATA318 Final Project/MuskTweets20-21")
file_contents2 <- list()
```
...
```{r}
#df1719$...1
cols_to_drop_2021 <- c("time","mentions", "new1","new2","new3")
cols_to_drop_1719 <- c("...1", "user_id_str", "day", "hour", "search")
...
write.csv(df1721, "C:/Users/13204/Documents/Data Mining/Final_Project/DATA318 Final Project/df1721.csv", row.names = FALSE)
```
